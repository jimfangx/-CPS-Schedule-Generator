    ...
    function starting() {
        ...
        var classes = ["", "", "", "", "", "", ""];
        classes[0] = document.getElementById('a').value;
        classes[1] = document.getElementById('b').value;
        classes[2] = document.getElementById('c').value;
        classes[3] = document.getElementById('d').value;
        classes[4] = document.getElementById('e').value;
        classes[5] = document.getElementById('f').value;
        classes[6] = document.getElementById('g').value;
